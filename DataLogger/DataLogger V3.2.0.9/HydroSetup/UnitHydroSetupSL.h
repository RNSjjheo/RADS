...
#ifndef UnitHydroSetupSLH
#define UnitHydroSetupSLH
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
class THydroSetupSL : public THydroSetup
{
__published:	// IDE-managed Components
	...
	TButton *cbShow;
	TButton *cbShowConf;
	TButton *cbShowSystem;
	TButton *cbShowSetup;
	TButton *cbShowDeploy;
	TButton *cbSetTime;
	TButton *cbHelp;
	TBevel *Bevel1;
...
//Local Function
	...
	__fastcall THydroSetupSL(TComponent* Owner);
};
//---------------------------------------------------------------------------
extern PACKAGE THydroSetupSL *HydroSetupSL;
//---------------------------------------------------------------------------
#endif
