...
THydroSetupAG *HydroSetupAG;

//---------------------------------------------------------------------------
__fastcall THydroSetupAG::THydroSetupAG(TComponent* Owner)
	: THydroSetup(Owner)
{
	m_iIdleSec = 0;
	m_bSleep   = false;
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::FormCreate(TObject *Sender)
{
//
}

//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::FormShow(TObject *Sender)
{
//
}

//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::FormClose(TObject *Sender, TCloseAction &Action)
{
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::FormCloseQuery(TObject *Sender, bool &CanClose)
{
//
}

//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::FormDestroy(TObject *Sender)
{
//
}

//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbSendClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbSendBreakClick(TObject *Sender)
{
	if ( ComPort->Open == false ) {
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbSaveSetupClick(TObject *Sender)
{
	if ( ComPort->Open == false ) {
		LogStatus("Port is not ready..");
		return;
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbCloseClick(TObject *Sender)
{
	ModalResult = mrNone;
...
//---------------------------------------------------------------------------
void THydroSetupAG::SensorStartNClose(bool bBreak)
{
	...
	if ( bBreak ) {		// Sleep 모드에 빠져있을 때. <BREAK> + "START" Command
		...
		ComPort->SetBreak(false);
		//SleepMsg(100);	// Wait for while to Sensor is ready..
	}
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::TimerTimer(TObject *Sender)
{
	m_iIdleSec++;
...
//---------------------------------------------------------------------------
// 종료 Timer
void __fastcall THydroSetupAG::TimerCloseTimer(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void THydroSetupAG::Receive(AnsiString sRecvMsg)
{
	m_sRecvMsg += sRecvMsg;
...
//---------------------------------------------------------------------------
void THydroSetupAG::Process(AnsiString sMsg)
{
	ShowRX(sMsg);
...
//---------------------------------------------------------------------------
void THydroSetupAG::ShowRX(AnsiString sRX)
{
...
//---------------------------------------------------------------------------
void THydroSetupAG::LogStatus(UnicodeString sLogMsg)
{
	StatusBar->SimpleText = sLogMsg;
}

//---------------------------------------------------------------------------
void THydroSetupAG::SetIdleZero()
{
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::edCommandKeyPress(TObject *Sender, System::WideChar &Key)
{
	if ( Key == '\r' ) {
		cbSendClick(Sender);
	}
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::edSaveClick(TObject *Sender)
{
	if ( ComPort->Open == false ) {
		LogStatus("Port is not ready..");
		return;
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbBreakClick(TObject *Sender)
{
	if ( ComPort->Open == false ) {
		LogMessage("Port is not ready..");
		return;
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::edShowClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbBlankDistanceClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbNCellsClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbCellSizeClick(TObject *Sender)
{
...
//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbCellCountClick(TObject *Sender)
{
// 	Undefine
}

//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::cbMeasureTimeClick(TObject *Sender)
{
//	Undefine
}

//---------------------------------------------------------------------------
void __fastcall THydroSetupAG::edSetTimeClick(TObject *Sender)
{
	if ( ComPort->Open == false ) {
		LogStatus("Port is not ready..");
		return;
