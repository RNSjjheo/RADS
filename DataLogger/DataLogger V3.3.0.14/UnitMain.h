...
__published:	// IDE-managed Components
	...
	void __fastcall TimerHydro3Timer(TObject *Sender);
	void __fastcall HydroPort3PortOpen(TObject *Sender);
	void __fastcall HydroPort3PortClose(TObject *Sender);
	void __fastcall HydroPort3TriggerAvail(TObject *CP, WORD Count);
	void __fastcall HydroPort3TriggerLineError(TObject *CP, WORD Error, bool LineBreak);
...
public:
	...
	char m_PreHydroMeter3[BUFFER_8K];
	...
	THydroSetup *m_pHydroSetup3;		// Hydro Setup Form Pointer
